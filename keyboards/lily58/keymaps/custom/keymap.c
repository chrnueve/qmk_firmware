 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,  KC_ENT,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT,  KC_RBRC,
                             KC_LALT, KC_LGUI,LOWER, KC_SPC,   KC_ENT,   RAISE,   KC_BSPC, KC_RIGHT_ALT
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |                    |  F7  |  F8  |  F9  | F10  | F11  | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |kcanOn|kcanof|kcantg|      |      |      |                    |      |   ↑  |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LShift|   !  |   @  |   #  |   $  |   %  |-------.    ,-------|   ←  |   ↓  |   →  |   (  |   )  |  PgUp|
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      |      |   +  |   {  |   }  |  -   |
...
[_LOWER] = LAYOUT(
  ...
  KC_LSFT, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_LEFT, KC_DOWN, KC_RIGHT, KC_LPRN, KC_RPRN, KC_PGUP,
  _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, _______, KC_PLUS, KC_LCBR, KC_RCBR, KC_SLSH,
...
/* bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        case KC_A:
            aHeld = key_pressed;
            if (dHeld && key_pressed) {
                unregister_code(KC_D);
            }
            if (!key_pressed || dHeld) {
                register_code(KC_A);
            } else {
        ...
        case KC_D:
            dHeld = key_pressed;
            if (aHeld && key_pressed) {
                unregister_code(KC_A);
            }
            if (!key_pressed || aHeld) {
                register_code(KC_D);
            } else {
                unregister_code(KC_D);
            }
